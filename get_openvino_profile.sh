...
for model in a8w8 f8e4m3 nvfp4 WOi4 WOi8 WOmxfp4 WOnf4; do
    ...
    OV_CPU_VERBOSE=3 taskset -c 0 python $ROOT_DIR/test_base_openvino.py --model $ROOT_DIR/model/$model/openvino_model.xml  --batch_size 1 --output $ROOT_DIR/profile_log/base/$model
